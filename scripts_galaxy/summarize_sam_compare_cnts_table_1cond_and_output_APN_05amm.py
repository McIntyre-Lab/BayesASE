...
def main():
    ...
    for index, sample in df_grouped.iterrows():
        ...
        g1_total = sample_id2 + "_" + "g1_total" + "_" + "rep" + str(count_good)
        g2_total = sample_id2 + "_" + "g2_total" + "_" + "rep" + str(count_good)
        both_total = sample_id2 + "_" + "both_total" + "_" + "rep" + str(count_good)
